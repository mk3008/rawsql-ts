...
- The current README still says `Run npx ztd agents init afterward` in the AI section even though Quickstart already includes it. That reads like a second placement rule.
