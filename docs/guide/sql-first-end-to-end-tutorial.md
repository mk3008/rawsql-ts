...
| SQL repair | `npx ztd model-gen --probe-mode ztd src/features/users-insert/queries/insert-users/insert-users.sql --out src/features/users-insert/queries/insert-users/boundary.ts` | Regenerate the query boundary from the SQL asset |
