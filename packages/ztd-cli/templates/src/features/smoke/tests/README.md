...
- `smoke.queryspec.test.ts` uses `@rawsql-ts/testkit-postgres` through `createPostgresTestkitClient`, requires `ZTD_TEST_DATABASE_URL`, and proves the starter DB-backed path.
