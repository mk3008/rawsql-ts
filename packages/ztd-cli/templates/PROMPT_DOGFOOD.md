...
- For `afterDb` false negatives, remember that the comparison is subset-based, row order is ignored, and volatile columns can stay out of the persistent case.
