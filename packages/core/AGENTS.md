...
Use before/after major changes to detect regressions in SQL formatting quality.\r\n### Build / Bundling Notes\r\n- esbuild ÇÃ --minify ÇÕéØï éqÇÃíZèkâªÇ‹Ç≈é¿é{Ç∑ÇÈÇΩÇﬂÅASelectItem ì‡Ç≈ÉRÉÅÉìÉgÇ™èdï°Ç∑ÇÈïsãÔçáÇ™î≠ê∂Ç∑ÇÈÅB\r\n- ÇªÇÃÇΩÇﬂ uild:minify Ç≈ÇÕ --minify-syntax --minify-whitespace ÇÃÇ›ÇégópÇµÅA--minify-identifiers ÇÕñ≥å¯âªÇµÇƒÇ¢ÇÈÅB\r\n- Ç‡Çµ --minify ÇçƒìxóLå¯Ç…Ç∑ÇÈèÍçáÇÕÅAESM/CJS ëoï˚ÇÃÉ~ÉjÉtÉ@ÉCê¨â ï®Ç≈ÉRÉÅÉìÉgèdï°Ç™çƒî≠ÇµÇ»Ç¢Ç±Ç∆ÇïKÇ∏åüèÿÇ∑ÇÈÇ±Ç∆ÅB
