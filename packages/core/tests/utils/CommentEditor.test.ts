...
describe('CommentEditor', () => {
    ...
    describe('addComment', () => {
        ...
        it('should add comment to SelectClause parsed from SQL', () => {
            ...
            const expectedSql = `SELECT/* Select user information */  /* Select user information */   "id", "name" FROM "users"`;
        ...
        it('should add multiple comments to different parts of SelectClause', () => {
            ...
            // Assert
            const result = formatter.format(query);
            const expectedSql = `SELECT/* Main SELECT clause */  /* Main SELECT clause */   /* Primary key */ "id", /* Display name */ "name" FROM "users" WHERE "active" = true`;
            expect(result.formattedSql).toBe(expectedSql);
        });
    });
    ...
    describe('editComment', () => {
        it('should edit existing comment on SelectClause', () => {
            ...
            // Assert
            const result = formatter.format(query);
            const expectedSql = `SELECT/* Updated comment */  /* Updated comment */   "id" FROM "users"`;
            expect(result.formattedSql).toBe(expectedSql);
        });
    ...
    describe('deleteComment', () => {
        ...
        it('should delete specific comment when multiple exist', () => {
            ...
            // Assert
            const result = formatter.format(query);
            const expectedSql = `SELECT/* First */  /* Third */  /* First */  /* Third */   "id" FROM "users"`;
            expect(result.formattedSql).toBe(expectedSql);
        });
    });
