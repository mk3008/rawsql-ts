...
describe('CommentEditor', () => {
    ...
    describe('addComment', () => {
        ...
        it('should add comment to SelectClause parsed from SQL', () => {
            ...
            const expectedSql = `/* Select user information */ SELECT "id", "name" FROM "users"`;
        ...
        it('should add multiple comments to different parts of SelectClause', () => {
            ...
            // Assert
            const result = formatter.format(query);
            const expectedSql = `/* Main SELECT clause */ SELECT /* Primary key */ "id", /* Display name */ "name" FROM "users" WHERE "active" = true`;
            expect(result.formattedSql).toBe(expectedSql);
        });
    });
    ...
    describe('editComment', () => {
        it('should edit existing comment on SelectClause', () => {
            ...
            // Assert
            const result = formatter.format(query);
            const expectedSql = `/* Updated comment */ SELECT "id" FROM "users"`;
            expect(result.formattedSql).toBe(expectedSql);
        });
    ...
    describe('deleteComment', () => {
        ...
        it('should delete specific comment when multiple exist', () => {
            ...
            // Assert
            const result = formatter.format(query);
            const expectedSql = `/* First */ /* Third */ SELECT "id" FROM "users"`;
            expect(result.formattedSql).toBe(expectedSql);
        });
    });
