...
describe('CTEDisabler', () => {
    ...
    test('disables complex multi-CTE analytics query with multiple unions', () => {
        // Arrange - Real-world analytics query with multiple CTEs, joins, and UNION operations
        const sql = `
        ...
        // Assert - Use custom formatter with specific formatting rules for comparison
