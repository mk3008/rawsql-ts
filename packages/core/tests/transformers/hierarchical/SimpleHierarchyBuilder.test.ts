    ...
    describe('Simple Object Relationships', () => {
        ...
        it('should handle nested object relationships: Order > Customer > Address', () => {
            ...
            const expectedSql = [
                ...
                `            *`,
                `            , case`,
                `                when "address_id" is null and "address_street" is null and "address_city" is null then`,
                `                    null`,
                `                else`,
                ...
                `            *`,
                `            , case`,
                `                when "customer_id" is null and "customer_name" is null then`,
                `                    null`,
                `                else`,
        ...
        it('should handle multiple object relationships: Product with Category and Supplier', () => {
            ...
            const expectedSql = [
                ...
                `            *`,
                `            , case`,
                `                when "category_id" is null and "category_name" is null then`,
                `                    null`,
                `                else`,
                `                    jsonb_build_object('id', "category_id", 'name', "category_name")`,
                `            end as "category_json_1"`,
                `            , case`,
                `                when "supplier_id" is null and "supplier_name" is null and "supplier_contact" is null then`,
                `                    null`,
                `                else`,
