import { DDLDiffGenerator } from '../src/transformers/DDLDiffGenerator.js';

console.log('Test 1: Check Names enabled');
...
diff1.forEach((d, i) => console.log(`Diff ${i}:`, d));

console.log('\nTest 2: Check Names disabled');
...
diff2.forEach((d, i) => console.log(`Diff ${i}:`, d));
