...
const DEFAULT_AFFINITY: SqliteAffinity = 'TEXT';

const affinityPatterns: Array<{ pattern: RegExp; affinity: SqliteAffinity }> = [
...
export function guessAffinity(typeName?: string): SqliteAffinity {
  if (!typeName) {
