 ...
 * @property tableDefinitions - Schema metadata in the same shape consumed by the runtime.
 * @property tableRows - Optional row fixtures generated or curated alongside the schema metadata.
 */
 ...
 * @property generated - Optional generated runtime metadata from `ztd-config`; preferred over raw DDL directories.
